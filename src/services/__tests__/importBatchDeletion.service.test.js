...
const buildDatabase = () => {
  const state = {
    ...
    transactions: [
      { id: 10, batchId: 10, customerId: 1, bookingType: "membership", validBooking: true },
      { id: 11, batchId: 20, customerId: 1, bookingType: "non_membership", validBooking: true },
      { id: 12, batchId: 20, customerId: 2, bookingType: "non_membership", validBooking: true },
      { id: 13, batchId: 20, customerId: 3, bookingType: "internal", validBooking: true },
      { id: 14, batchId: 30, customerId: 4, bookingType: "membership", validBooking: true },
    ],
